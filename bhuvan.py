...
screen.fill(WHITE)
pygame.draw.rect(screen, BLACK, [WIDTH/2-300, HEIGHT/2-300, 250, 150])
text = pygame.font.Font('freesansbold.ttf', 40)
textsurf = text.render("Animals", True, BLACK)
screen.blit(textsurf, (WIDTH/2-150, HEIGHT/2-150))
hangman_status = 0
...
sport = [['rugby','golf','karate','tennis','cricket'],['football', 'netball', 'basketball', 'swimming','curling'],
         ['running','badmington', 'archery', 'volleyball', 'bowling'], ['dancing', 'skating', 'baseball','rounders','boxing'],
         ['climbing', 'cycling', 'fencing',  'shooting','kabaddi']]
    #print("sport")
    #title = "Sports"
